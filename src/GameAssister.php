...
class GameAssister
{
    public function saveToDrawJson($ptsAI , $ptsPlayer, $decision){
        ...
        return "Zapisuje do pliku draw.json ptsPlayer: {$ptsPlayer} decyzja: {$decision} ptsDealer: {$ptsAI}";
    }
    public function saveGamesJson($ptsAI , $ptsPlayer, $gameStatus){
        ...
        return "Zapisuje do pliku draw.json ptsPlayer: {$ptsPlayer} decyzja: {$gameStatus} ptsDealer: {$ptsAI}";
    }
}